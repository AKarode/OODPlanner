...
public class OurEvent {
  ...
  /**
   * Constructs a new OurEvent with specified details.
   ...
   */
  public OurEvent(String name, String location, boolean onlineStatus, String startDay,
   ...
   */
  public boolean isOverLapping(OurEvent other) {
