...
public class  PlannerController implements Features {
  ...
  public void createEvent(String name, String location, boolean onlineStatus,
    ...
    OurEvent ourEvent = new OurEvent(name, location, onlineStatus,
        startDay, startTime, endDay, endTime, host, invitedUsers);
    model.createEvent(ourEvent);
  }

  @Override
  public void modifyEvent(OurEvent oldOurEvent, OurEvent newOurEvent) {

    model.updateEvent(oldOurEvent, newOurEvent);

  }

  @Override
  public void removeEvent(OurEvent ourEventToRemove) {
    model.removeEvent(ourEventToRemove);
