...
public class TextViewTest {
  ...
  @BeforeEach
  void setUp() {
    OurEvent testOurEvent1;
    OurEvent testOurEvent2;
    ...
    testOurEvent1 = new OurEvent("Test OurEvent 1", "Location 1", true,
        "Monday", "0900", "Monday", "1000",
        testUser, List.of(testUser));

    testOurEvent2 = new OurEvent("Test OurEvent 2", "Location 2", false,
        "Tuesday", "1100", "Tuesday", "1200", testUser,
        List.of(testUser));

    // Add events to the user's schedule
    testUser.getSchedule().getEvents().add(testOurEvent1);
    testUser.getSchedule().getEvents().add(testOurEvent2);
  ...
  void testBuildUserSchedule() throws IOException {
    ...
    String expected = "User: Test User\n" +
        "Sunday:\n" +
        "Monday:\n" +
        "\tname: Test OurEvent 1\n" +
        "\ttime: Monday: 0900 -> Monday: 1000\n" +
        "\tlocation: Location 1\n" +
        "\tonline: true\n" +
        "\tinvitees: Test User\n\n" +
        "Tuesday:\n" +
        "\tname: Test OurEvent 2\n" +
